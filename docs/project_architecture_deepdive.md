# CredResolve Streaming ASR — Whole-Project Deep-Dive

> Companion narrative to [docs/flowchart.mmd](flowchart.mmd). The flowchart is the map; this document is the guidebook — what each block does, why it exists, and which files to read.
...
Routing between the two lives in `_TritonDispatchModel` ([worker/app/triton.py:311](../worker/app/triton.py#L311)). Full deep-dive on this split is in [docs/ctc_vs_rnnt_decoder_deepdive.md](ctc_vs_rnnt_decoder_deepdive.md) and [docs/triton_native_serving_plan.md](triton_native_serving_plan.md).
...
For TensorRT compilation of the encoder (the ~90% compute), see [docs/TensorRT & Triton Inference Server — Complete Deep-Dive.md](TensorRT%20%26%20Triton%20Inference%20Server%20%E2%80%94%20Complete%20Deep-Dive.md).
...
| Switch decoders | [docs/ctc_vs_rnnt_decoder_deepdive.md](ctc_vs_rnnt_decoder_deepdive.md) |
| Make Triton faster | [docs/triton_native_serving_plan.md](triton_native_serving_plan.md), [docs/TensorRT & Triton Inference Server — Complete Deep-Dive.md](TensorRT%20%26%20Triton%20Inference%20Server%20%E2%80%94%20Complete%20Deep-Dive.md) |
...
| Tune context biasing | [context_biasing/README.md](../context_biasing/README.md), [docs/dynamic_context_biasing_demo.md](dynamic_context_biasing_demo.md), [worker/app/context_biasing.py](../worker/app/context_biasing.py) |
| Run an eval | [tools/eval_indicvoices_wer.py](../tools/eval_indicvoices_wer.py), [docs/indicvoices_eval.md](indicvoices_eval.md) |
...
| See system design rationale | [docs/production_system_design.md](production_system_design.md), [docs/knowledge_transfer.md](knowledge_transfer.md) |
