...
> DeepFilterNet3 vs RNNoise decision live in [audio_denoiser_eval.md](audio_denoiser_eval.md).
...
| `docs/audio_denoiser_eval.md` | Evaluation data: WER and latency benchmarks that drove the DFN3 selection |
| `docs/audio_pipeline.md` | Full audio pipeline context (VAD + denoiser + resampler) |
