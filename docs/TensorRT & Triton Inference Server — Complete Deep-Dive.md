# TensorRT & Triton Inference Server — Complete Deep-Dive
...
**Immediate action**: Deploy the CTC ensemble inside the Triton container, copy model artifacts per the [deploy runbook](file:///home/ubuntu/CredResolve_Production_grade_Streaming_ASR/docs/triton_native_serving_plan.md#L153-L190), validate WER parity, then enable TRT EP for the encoder.
