...
- Config: `audio/Hindi`
- Split: `train`
- Snapshot fetched: 2026-05-08 (UTC)
...
|---|---|---|---|
| `01_iisc_vaaniproject_m_biha.wav` | 73 | 2.24 | <noise> विद्यापति आश्रम है-- </noise> |
| `02_iisc_vaaniproject_m_biha.wav` | 120 | 2.12 | <noise> घर नजर आ रहा है। </noise> |
| `03_iisc_vaaniproject_k_utta.wav` | 259 | 3.966 | <noise> यह [unintelligible] लाल रंग की एक किताब है जो कि पंडित लोग-- </noise> |
| `04_iisc_vaaniproject_k_jhar.wav` | 292 | 3.158 | कुछ लोग क्रिकेट {cricate} खेल रहे है। |
